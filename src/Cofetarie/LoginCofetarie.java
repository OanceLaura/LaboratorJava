...
public class LoginCofetarie extends javax.swing.JFrame {

    public LoginCofetarie() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label2 = new javax.swing.JPasswordField();
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
         ...
         String value2=label2.getText();
          if (value1.equals("vio") && value2.equals("vio")) {
		new MeniulPrincipal().setVisible(true);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(LoginCofetarie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginCofetarie().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPasswordField label2;
    // End of variables declaration//GEN-END:variables

    private static class MeniulPrincipal {
